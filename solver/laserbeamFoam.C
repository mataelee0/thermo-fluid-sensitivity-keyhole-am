...
int main(int argc, char *argv[])
{
    ...
    while (pimple.run(runTime))
    {
        ...
        while (pimple.loop())
        {
			...
			scalar time3 = runTime.elapsedCpuTime();

            #include "updateProps.H"
			scalar time4 = runTime.elapsedCpuTime();
			#include "MTpart.H"
			scalar time5 = runTime.elapsedCpuTime();
			...
			scalar time6 = runTime.elapsedCpuTime();
            ...
            #include "UEqn.H"
			scalar time7 = runTime.elapsedCpuTime();

            #include "TEqn.H"
			scalar time8 = runTime.elapsedCpuTime();
			...
			scalar time9 = runTime.elapsedCpuTime();
			...
			Info << endl << "#### Time spend ### " << endl;
		    Info << "1. Mesh: " << time2 - time1 << endl;
		    Info << "2. alphaEqn: " << time3 - time2 << endl;
		    Info << "3. updateProps: " << time4 - time3 << endl;
		    Info << "4. MTpart: " << time5 - time4 << endl;
		    Info << "5. Laser update: " << time6 - time5 << endl;
		    Info << "6. UEqn: " << time7 - time6 << endl;
		    Info << "7. TEqn: " << time8 - time7 << endl;
		    Info << "8. pEqn: " << time9 - time8 << endl;
		    Info << "Total: " << time9 - time1 << endl;
        }
